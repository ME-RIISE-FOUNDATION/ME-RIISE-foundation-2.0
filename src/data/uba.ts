...
export const UBA_EVENTS: UbaEvent[] = [
  {
    ...
    images: ["/uba/train4.jpg", "/uba/Train1.jpg", "/uba/train3.jpg", "/uba/train5.jpg"],
    pdfs: [{ label: "Train the Trainers – Report", path: "/uba/Trainthetrainers.pdf" }],
  },
  {
    id: 2,
    title: "Gramavasthavya",
    subtitle: "Innovation & Entrepreneurship Outreach Program in Schools / Community",
    date: "15/02/2024",
    description:
    ...
    pdfs: [
      ...
      { label: "UBA Visit – Dudda", path: "/uba/events23/UBA visit , Dudda.pdf" },
    ],
  },
  {
    id: 3,
    ...
    pdfs: [
      { label: "Basics of Computers – Heragu", path: "/uba/Imparting Basics of Computers-Heragu.pdf" },
      { label: "Basics of Computers – Gopanahalli", path: "/uba/Imparting Basics of Computers-Gopanahalli.pdf" },
    ],
  },
  {
    id: 4,
    ...
    pdfs: [
      { label: "Virtual School – Dudda School", path: "/uba/Virtual_sc/Report - VIRTUAL SCHOOL - Dudda School.pdf" },
      { label: "Virtual School – Heragu", path: "/uba/Virtual_sc/Report - VIRTUAL SCHOOL - Heragu.pdf" },
      { label: "Virtual School – Anuguvalli", path: "/uba/Virtual_sc/Report - VIRTUAL SCHOOL -Anuguvalli.pdf" },
      { label: "Virtual School – Gopanahalli", path: "/uba/Virtual_sc/Report - VIRTUAL SCHOOL -Gopanahalli.pdf" },
      { label: "Virtual School – Lingarasanahalli", path: "/uba/Virtual_sc/Report - VIRTUAL SCHOOL -Lingarasanahalli.pdf" },
    ],
  },
  {
    id: 5,
    ...
    images: ["/uba/soil.jpg"],
    pdfs: [
      { label: "Soil Health Analysis – Report", path: "/uba/Soil_health/Soil Health Analysis and Management of Plant Nutrition.pdf" },
    ],
  },
  {
    id: 6,
    ...
    images: ["/uba/bird.jpg"],
    pdfs: [{ label: "Bird Watching – Report", path: "/uba/Bird_watch/Bird Watching.pdf" }],
  },
  {
    id: 7,
    title: "Rural Awareness Programme",
    subtitle: "Plant Pathology and Microbes in Bio Enrichment — Practical & Awareness Session",
    date: "06/02/2021",
    description:
    ...
    pdfs: [{ label: "Rural Awareness Programme – Report", path: "/uba/Rural/Rural awareness programme.pdf" }],
  },
  {
    id: 8,
    ...
    pdfs: [
      { label: "Plastic Free Campaign – Gopanahalli", path: "/uba/Plastic_free/Plastic Free Campaign - 30-09-2019 - Gopanahalli.pdf" },
      { label: "Plastic Free Campaign – Heragu", path: "/uba/Plastic_free/Plastic Free Campaign - Heragu.pdf" },
      { label: "Plastic Free Campaign – Schedule", path: "/uba/Plastic_free/Plastic Free Campaign -Schedule.pdf" },
    ],
  },
  {
    id: 9,
    ...
    pdfs: [
      { label: "Planting – Anuguvalli", path: "/uba/Planting/Planting Tree Samplings - Anuguvalli– 01-08-2019.pdf" },
      { label: "Planting – Dudda", path: "/uba/Planting/Planting Tree Samplings - Dudda – 01-08-2019.pdf" },
      { label: "Planting – Gopanahalli", path: "/uba/Planting/Planting Tree Samplings - Gopanahalli – 01-08-2019.pdf" },
      { label: "Planting – Heragu", path: "/uba/Planting/Planting Tree Samplings - Heragu – 01-08-2019.pdf" },
      { label: "Planting – Lingarasanahalli", path: "/uba/Planting/Planting Tree Samplings - Lingarasanahalli– 01-08-2019.pdf" },
    ],
  },
  {
    id: 10,
    ...
    pdfs: [{ label: "Science Expo – Report", path: "/uba/Science_expo/One day Science Expo.pdf" }],
  },
  {
    id: 11,
    ...
    pdfs: [
      { label: "Household Survey – Dudda", path: "/uba/Household_survey/docs/Household survey Dudda-25-03-2019.pdf" },
      { label: "Household Survey – Heragu", path: "/uba/Household_survey/docs/Household survey- Heragu.pdf" },
      { label: "Household Survey – Lingarasanahalli", path: "/uba/Household_survey/docs/Household survey- Lingarasanahalli.pdf" },
      { label: "Household Survey – Anuguvalli", path: "/uba/Household_survey/docs/Household survey-Anuguvalli.pdf" },
      { label: "Household Survey – Gopanahalli", path: "/uba/Household_survey/docs/Household survey-Gopanahalli.pdf" },
    ],
  },
  {
    id: 12,
    ...
    pdfs: [
      { label: "Village Survey – Anuguvalli", path: "/uba/Village_survey/Village survey _Anuguvalli– 10-12-2018.pdf" },
      { label: "Village Survey – Dudda", path: "/uba/Village_survey/Village survey _Dudda – 10-12-2018.pdf" },
      { label: "Village Survey – Gopanahalli", path: "/uba/Village_survey/Village survey _Gopanahalli – 10-12-2018.pdf" },
      { label: "Village Survey – Heragu", path: "/uba/Village_survey/Village survey _Heragu – 10-12-2018.pdf" },
      { label: "Village Survey – Lingarasanahalli", path: "/uba/Village_survey/Village survey _Lingaransahalli– 10-12-2018.pdf" },
      { label: "Schedule – 10/12/2018", path: "/uba/Village_survey/Schedule – 10-12-2018.pdf" },
    ],
  },
];
