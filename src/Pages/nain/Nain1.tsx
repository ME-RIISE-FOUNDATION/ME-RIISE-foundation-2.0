...
import { NAIN1_EVENTS } from "@/data/nain/nain1";
...
export default function Nain1Page() {
    ...
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-white">
      ...
      <div className="relative overflow-hidden bg-linear-to-br from-slate-900 via-brand-navy to-slate-900 py-24 px-6 text-center">
        ...
        >
          ...
          <span className="block text-brand-blue mt-1">1.0 &amp; 1.2</span>
        </motion.h1>
        <motion.div
        ...
        >
          A complete archive of events, workshops, and activities from NAIN 1.0 &amp; 1.2
        </motion.p>
      </div>
      ...
      <div className="bg-brand-navy/5 border-b border-brand-navy/10 py-4 px-6 text-center">
        <p className="text-sm font-medium text-brand-navy">
          <span className="font-bold text-brand-blue">{NAIN1_EVENTS.length}</span> events &amp; activities
        </p>
      </div>

      {/* ── Events List ── */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 space-y-14">
        {NAIN1_EVENTS.map((event, idx) => (
          <motion.div
            key={event.id}
          ...
          >
            ...
            <div className="rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-300 bg-white">
              ...
              {/* Header bar */}
              <div className="bg-linear-to-r from-brand-navy to-brand-blue px-8 py-6 flex items-start gap-5">
